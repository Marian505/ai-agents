...
from rag_agent.rag_agent import load_web, agent
...
async def _data_init(project_name: str, dataset_name: str):
    ...
    dataset_list = [d async for d in aclient.list_datasets()]
    ...
    if dataset_name not in dataset_names:
        ...
        dataset = next(d for d in dataset_list if d.name == dataset_name)
...
#     await _data_init(project_name, dataset_name)
...
#         experiment_prefix="test-rag-correctness",
